...
//Going to connect to firebase faced with issue for now
//User values (name, e-mail, password, allergies, address) will be displayed in placeholders and can be changed with the edit button
